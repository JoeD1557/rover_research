...
{
    model->enableStereoUi = _window->property("enableStereoUi").toBool();
    ...
    model->selectedVideoResolution = _window->property("selectedVideoResolution").toInt();
...
void ControlWindowController::updateFromSettingsModel(const SettingsModel *model)
{
    ...
    _window->setProperty("videoResolutionNames", model->videoResolutionNames);
    _window->setProperty("cameraNames", model->cameraNames);
    _window->setProperty("roverAddress", model->roverAddress.toString());

    _window->setProperty("enableStereoUi", model->enableStereoUi);
    ...
    _window->setProperty("selectedVideoResolution", model->selectedVideoResolution);
